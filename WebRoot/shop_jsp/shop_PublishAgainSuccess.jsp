...
<div class="bottom">
	<div class="bottom-shop">
    	<div id="userMessage">
        	<table width="879" id="user-table" heigth="140" border="0">
            	<tr>
                	<td width="360"><div id="user-photo"><img src="${sessionScope.loginuser.userImage}" width="100" height="100"></div></td>
                	<td width="509" ><div id="down-good"><a href="#">待修改商品</a></div></td>
                </tr>
        ...
        <div id="gooddown">
          <s:iterator id="goodItem" value="#request.goodList" status="st">
           ...
           <div class="gooddown-item1">
               ...
               <a href="${pageContext.request.contextPath}/shop_toUpdateGood.action?findBygoodid=<s:property value="goodId"/>"><button type="button" class="subAgain">重新编辑</button></a>
