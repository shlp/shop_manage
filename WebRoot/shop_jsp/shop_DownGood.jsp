...
<html>
  <head>
	...
	<link rel="stylesheet" href="css/shop/DownGood.css">
    	...
    	<div id="userMessage">
        	<table width="879" id="user-table" border="0">
            	<tr>
                	...
                	<td width="509" ><div id="down-good"><a href="#">下架商品</a></div></td>
                </tr>
        ...
        <div id="gooddown">
          <s:iterator id="goodItem" value="#request.goodList" status="st">
           ...
           <div class="gooddown-item1">
				        ...
				        <div class="div_iterm" >
				        	<h1 class="confirm">主动下架</h1>
				        	<h1 class="confirmup">你已下架了该宝贝，可以选择重新发布</h1>				        	
                ...
                <div class="gooddownitem">
                   	 <span class="downself">主动下架</span>
                     <span class="down-cause">下架原因< </span>
                </div>
               <hr class="goodhr"></hr>
               ...
               <div class="gooddown-sub">
                 ...
                 <a href="${pageContext.request.contextPath}/shop_toUpdateGood.action?findBygoodid=<s:property value="goodId"/>"><button type="button" class="subAgain">重新发布</button></a>
                  <a href="${pageContext.request.contextPath}/shop_updateGoodState.action?findBygoodid=<s:property value="goodId"/>&goodState=yishangjia"> 
                 
                <%--  <input type="hidden" class="good-id" name="goodId" value="<s:property value="goodId"/>"/>
				 <input type="hidden" class="good-state" name="goodState" value="yishangjia"/> --%>
                    <button type="button" class="upGood">直接上架</button>  </a>
                 <a href="${pageContext.request.contextPath}/shop_deleteGood.action?findBygoodid=<s:property value="goodId"/>">
            ...
            <div class="gooddown-item">
               ...
               <div class="gooddown-sub">
               		<!-- <div class="div_black" class="div_black"></div>
                 		    <h1 class="confirmup">确认上架吗?</h1>
				            <h1 class="confirmdelete">确认删除吗?</h1>
				        <div class="div_iterm" >
				            <div class="div_sub"><button  class="submit_btn">确认</button></div>
				            <div class="div_cancle"><button class="close_btn">取消</button></div>         
				        </div>
						<div class="div_iterm1">				           			           
				            <div class="div_sub"><button  class="delete-btn">确认</button></div>		            
				            <div class="div_cancle"><button class="close_btn1">取消</button></div>         
				        </div> -->
                 <a href="${pageContext.request.contextPath}/shop_toUpdateGood.action?findBygoodid=<s:property value="goodId"/>"><button type="button" class="subAgain">重新发布</button></a>
                 <a href="${pageContext.request.contextPath}/shop_updateGoodState.action?findBygoodid=<s:property value="goodId"/>&goodState=yishangjia"> 
                
                 <input type="hidden" class="good-id" name="goodId" value="<s:property value="goodId"/>"/>
                 <input type="hidden" class="good-state" name="goodState" value="以上架"/>
