...
public class Orderform implements java.io.Serializable {
	...
	/** minimal constructor */
	public Orderform(Goods goods, Users users, Double goodsPrice, Integer goodsNum, String userName, String userTel,
			String userAdd, Date buyTime) {
		this.goods = goods;
		this.users = users;
	...
	/** full constructor */
	public Orderform(Goods goods, Users users, Double goodsPrice, Integer goodsNum, String userName, String userTel,
			String userAdd, Date buyTime, Date getTime, String formStatus, String logisticsNumber, Set evaluateforms) {
		this.goods = goods;
		this.users = users;
		this.goodsPrice = goodsPrice;
		this.goodsNum = goodsNum;
